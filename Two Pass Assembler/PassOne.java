...
public class PassOne {
    ...
    public static void mapper() {
        try {
            String newSt = "";
            FileInputStream input = new FileInputStream("C:/Users/parth/Downloads/LP-1 Dataset/ASSEMBLER PASS I/mot.txt");
            int i = input.read();
            while (i != -1) {
                newSt += (char) i;
                i = input.read();
    ...
    public static String[] inputFileRead() {
        ...
        try {
            ...
            FileInputStream input = new FileInputStream("C:/Users/parth/Downloads/LP-1 Dataset/ASSEMBLER PASS I/input.txt");
            int i = input.read();
            while (i != -1) {
                newSt += (char) i;
                i = input.read();
